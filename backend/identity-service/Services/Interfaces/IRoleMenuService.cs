...
public interface IRoleMenuService
{
    ...
    Task<Result<List<RoleMenuResponseDto>>> GetByRoleIdAsync(Guid roleId);
    Task<Result<List<MenuWithRoleMenuDto>>> GetMenusByRoleAsync(Guid roleId);
    Task<Result<bool>> UpdateAccessLevelsForRoleAsync(string performedByUserId, Guid roleId, List<RoleMenuAccessUpdateDto> updates);
