...
public interface IAuthService
{
    ...
    public Task<Result<AuthResponseSsoDto>> LoginLdapAsync(LoginLdapDto dto, string device, string? ip);
    Task<Result<AuthResponseDto>> GenerateSystemAccessTokenAsync(string userId, string sessionJti, string system, string scope, string device, string ip);
